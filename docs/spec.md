...
> ✅ **Cerrado el 2026-07-25 (noche) — [ticket 023](tasks/023-puente-capacidad-antes-del-proyecto.md).** "No pasa el corte" ya significa lo que debe: *no le cabe nada del catálogo*. Antes significaba *no le cabe el proyecto que miró* —el gate se evalúa contra un solo proyecto— y un lead con capacidad para 13 de los 18 caía a nutrición por haber elegido uno caro. Hoy la capacidad se resuelve primero y, si el proyecto de entrada no cabe pero otro sí, se recalifica contra ese **diciéndolo en la ficha**. **La afiliación, en cambio, nunca manda a nadie a nutrición** (se dijo al revés en la sala del sábado): el no afiliado que pasa el gate sale *Listo con restricción de cupo*.
...
**[HOY — desde 2026-07-26] Y después de esas, hasta dos más: el banco de preguntas.** La tabla de arriba es lo que el motor necesita para **calificar**; el banco pregunta lo que separa a los proyectos que ya le caben, o sea lo que mejora la **recomendación** (alcobas, amenidades, espacio, momento de compra). Solo entra si alguna cambiaría la lista que se le va a dar: si ninguna vale la pena no pregunta nada y el lead nunca se entera. Las preguntas son cuatro, escritas a mano y elegidas midiendo los 18 brochures; el modelo **escoge una de esa lista**, no la escribe. Contrato en [spec 02 D8](specs/02-conversador.md).
