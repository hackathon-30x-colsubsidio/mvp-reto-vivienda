...
> ✅ **La razón 1 volvió a significar lo que dice, el 2026-07-25 (noche)** ([ticket 023](../tasks/023-puente-capacidad-antes-del-proyecto.md), hallado en la [discusión de workflow](../agents/discusion-workflow-2026-07-25.md) §2.1). Hasta esa tarde el gate se evaluaba **contra un solo proyecto**, así que existía de hecho una fila 1b: un lead con $4.000.000 que eligió ARAUCARIA caía a `nutricion` con cero proyectos, cuando **13 de los 18 le cabían**. Eso no era nutrición, era un match mal hecho, y además contaminaba la métrica "En nutrición, con trigger" del tablero. Hoy la capacidad se resuelve antes de elegir el proyecto de referencia, y **nutrición significa lo único que debería: no le cabe nada de lo que vendemos**.
