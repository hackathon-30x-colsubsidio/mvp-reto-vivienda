...
Del brief ([brief:47-50](../sources/retos/leads/perfilamiento-leads-03.md)):
...
2. Bajar este layout a `spec.md` (7 bloques) + tasks (Día 1 del [PLAN.md](PLAN.md)).
