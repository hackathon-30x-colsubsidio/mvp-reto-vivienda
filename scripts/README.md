...
- **VIBO ONCE y KARAKALI: ubicación contradictoria entre hojas** (RICAURTE en "Links brochure" vs. BOGOTÁ en "360"). **Resuelta el 2026-07-25 con una tercera fuente: el material comercial oficial**, que trae la dirección exacta — Karakalí en **Bogotá, Chapinero** (Cra 15 # 63A-22) y Vibo Once en **Bogotá, Centro** (Cra 14 # 3-58), ver [`docs/proyectos/proyectos-colsubsidio.md`](../docs/proyectos/proyectos-colsubsidio.md). Vive en `UBICACION_RESUELTA_POR_BROCHURE` (`generar_sintetica.py`), y por eso quedan con `ciudad_inferida: false`: hay dirección y barrio, no una deducción nuestra.
  - El mecanismo para una contradicción **futura** sigue en pie: sin fuente que la resuelva, la ciudad queda como el string explícito `"Ricaurte o Bogotá (ubicación contradictoria entre hojas, sin confirmar)"` + `ubicacion_incierta: true`, y el matcher no la cuenta como coincidencia de zona (no se le promete al lead una ciudad que la fuente no confirma).
